...
abstract class LSYii_Controller extends CController
{
    ...
    protected function _init()
    {
        ...
        if (!function_exists('mb_convert_encoding'))
            $dieoutput .= "This script needs the PHP Multibyte String Functions library installed: See <a href='http://qc.md/wiki/Installation_FAQ'>FAQ</a> and <a href='http://de.php.net/manual/en/ref.mbstring.php'>PHP documentation</a><br />";
