...
class WipeCommand extends CConsoleCommand
{
    ...
    public function run($sArgument)
    {
        ...
        else
        {
            ...
            echo 'This CLI command wipes a QstConn installation clean (including all user except for the user ID 1 and user-uploaded content). For security reasons this command can only started if you add the parameter \'yes\' to the command line.';
        }
